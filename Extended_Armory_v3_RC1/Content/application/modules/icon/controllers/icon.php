...
class Icon extends MX_Controller
{
	...
	private function getDisplayId($entry, $realm)
	{
		...
		{
			return $this->getDisplayIdDB3($entry, $realm);
		}
	...
	private function getDisplayIdDB3($entry, $realm)
	{
